...
class ViewController: UIViewController {
    ...
    func setupThirdContainer(containerView:UIView) {
        ...
        self.creditsLabel.textColor = UIColor.blackColor()
        self.creditsLabel.font = UIFont(name: "AmericanTypewriter", size: 14)
        self.creditsLabel.sizeToFit()
        self.creditsLabel.center = CGPointMake(containerView.frame.width * kSixth, containerView.frame.height * kThird * 2)
        containerView.addSubview(self.creditsLabel)
    ...
    func setupFourthContainer(containerView:UIView) {
        ...
        self.betOneButton.titleLabel?.font = UIFont(name: "Superlarendon-Bold", size: 12)
        ...
        self.spinButton.titleLabel?.font = UIFont(name: "Superlarendon-Bold", size: 12)
